	...
	<div class="row">
		<div class="columns large-12">
			<div class="ad">
                ...
                <h3><a style="color:#fff; font-size:30px; padding-top:10px;" href="http://www.zocdoc.com/practice/ent-memphis-31673" target="_blank" data-type="book-button" data-practice-id="31673">
        <?php echo esc_attr( ot_get_option('wpl_booknow_title') ) ?>
    </a></h3>
					<?php /*?><?php if ( ot_get_option('wpl_booknow_title') ){ echo '<h3>' . esc_html(ot_get_option('wpl_booknow_title')) . '</h3>'; } ?>

					<?php if ( ot_get_option('wpl_booknow_subtitle') ){ echo '<p>' . esc_html(ot_get_option('wpl_booknow_subtitle')) . '</p>'; } ?><?php */?>
				</header><!-- /.ad-head -->
