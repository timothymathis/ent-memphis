...
class wplook_cf7_home_widget extends WP_Widget {
	...
	if ( $instance ) {
	$subtitle1 = esc_attr( $instance[ 'subtitle1' ] );
	}
	else {
	$subtitle1 = __( 'It\'s easy and fast', 'healthmedical-wpl' );
	}
		...
		?>
			...
			<p>
                ...
                <input class="widefat" id="<?php echo $this->get_field_id('subtitle1'); ?>" name="<?php echo $this->get_field_name('subtitle1'); ?>" type="text" value="<?php echo $subtitle1; ?>" />
			</p>
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['subtitle1'] = sanitize_text_field($new_instance['subtitle1']);
	...
	public function widget( $args, $instance ) {
		...
		$subtitle1 = isset( $instance['subtitle1'] ) ? esc_attr( $instance['subtitle1'] ) : '';
					...
					<div class="form-appointment">
						<header class="form-head row">
							...
							<div class="columns large-12 medium-12">
                                ...
                                <?php if($subtitle1) { ?><h6 clsss="subtitle1"><?php echo esc_attr($subtitle1); ?></h6><?php } ?>
						...
						<div class="form-body">
							...
							<?php /*?><?php echo do_shortcode( '[contact-form-7 id="' . $form . '" title="' . get_the_title( $form ) . '"]' ); ?><?php */?>
                            <div style="text-align:center;">
							<a class="button btn-light-blue btn-small" href="http://www.zocdoc.com/practice/ent-memphis-31673" target="_blank">Book Appointment</a>
							</div>
