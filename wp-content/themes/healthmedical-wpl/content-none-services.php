<?php
/**
 * The content template file for when no services could be found
 *
 * @package WordPress
			...
			<article class="event article-single-event">
				...
				<div class="entry-content">
					<div class="event-body" itemprop="articleBody">
						<h2 class="error-subtitle text-center"><?php _e('The services you were looking for could not be found.', 'healthmedical-wpl'); ?></h2>
